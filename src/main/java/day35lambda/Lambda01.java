...
public class Lambda01 {
    ...
    // Bir list'teki cift elemanlari aralarina bosluk koyarak yazdiran method'u olusturunuz.(Structured)
    ...
    // Bir list'teki cift elemanlari aralarina bosluk koyarak yazdiran method'u olusturunuz.(Functional)
    ...
    // 6) Create a method to print the "cube" of "distinct" "odd" list elements on the console in the same line with a space between two consecutive elements.(Functional)
    ...
    public static void printSumOfSquaresOfDistinctEvenElements(List<Integer> nums){
        ...
        Integer sum = nums.
                ...
                filter(t -> t%2==0).
                map(t -> t*t).
                reduce(0,(t, u) -> t+u); // sum methodu gibi çalışıyor t ve u toplayıp, t ye koyar.
