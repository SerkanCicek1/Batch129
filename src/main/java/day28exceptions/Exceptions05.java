...
public class Exceptions05 {
    ...
    // Exception Class'lar arasinda "parent - child" iliskisi varsa, ya child class'i uste yazarak child ve
    // parent class'lar icin ozellestirilmis code'lar yazarsiniz.(Hirsiz icin 155, hasta icin 112 gibi)
