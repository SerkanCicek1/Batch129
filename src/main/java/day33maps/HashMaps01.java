...
public class HashMaps01 {
    ...
    /*
      ...
      5) "Entry" ler "unique" dir cunlu key kisimlari unique oldugundan her bir "Entry" birbirinden farklidir
    ...
    public static void main(String[] args) {
        ...
        // HashMap'lerde sadece "value" nasil alinir ?
        // Example: hm Map'indeki ulkelerin toplam nufusunu bulunuz
        ...
        // HashMap'lerde belirli bir "key" in "value" sunu nasil aliriz ?
        Integer usaPopulation = hm.get("USA");
        System.out.println(usaPopulation);

        // HashMap'lerde replace() methodu bir "key" in "value" degerini degistirmek icin kullanilir
        ...
        // Example: Yeni ogretmenin maasi standart ucretten 1000TL fazla, eski ogretmenin maasi 2000TL fazla olsun
        ...
        // replace("USA",400000000,500000000) meyhodu key USA ve value 400000000 i value'u 500000000 yapar
